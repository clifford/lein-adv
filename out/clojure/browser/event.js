...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj6026 = {};return obj6026;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3547__auto__ = this$;if(and__3547__auto__)
...
{var x__4186__auto__ = (((this$ == null))?null:this$);return (function (){var or__3559__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4186__auto__)]);if(or__3559__auto__)
{return or__3559__auto__;
} else
{var or__3559__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3559__auto____$1)
...
return (function (p__6027){var vec__6028 = p__6027;var k = cljs.core.nth.call(null,vec__6028,0,null);var v = cljs.core.nth.call(null,vec__6028,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__6029){var vec__6030 = p__6029;var k = cljs.core.nth.call(null,vec__6030,0,null);var v = cljs.core.nth.call(null,vec__6030,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
