...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__4045__auto__,writer__4046__auto__,opt__4047__auto__){return cljs.core._write(writer__4046__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_25519 = 0;while(true){
if((i_25519 < arr.length))
{(arr[i_25519] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__4045__auto__,writer__4046__auto__,opt__4047__auto__){return cljs.core._write(writer__4046__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_25526 = (self__.level + 1);while(true){
if((i_25526 <= (new_level + 1)))
{(update[i_25526] = self__.header);
{
var G__25527 = (i_25526 + 1);
i_25526 = G__25527;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.cljs$core$IFn$_invoke$arity$4(self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_25528 = 0;while(true){
if((i_25528 <= self__.level))
{var links_25529 = (update[i_25528]).forward;if(((links_25529[i_25528]) === x__$1))
{(links_25529[i_25528] = (x__$1.forward[i_25528]));
{
var G__25530 = (i_25528 + 1);
i_25528 = G__25530;
continue;
}
} else
{{
var G__25531 = (i_25528 + 1);
i_25528 = G__25531;
continue;
}
}
...
cljs.core.async.impl.dispatch.queue_delay(((function (timeout_channel,or__3478__auto__,timeout__$1,me){
